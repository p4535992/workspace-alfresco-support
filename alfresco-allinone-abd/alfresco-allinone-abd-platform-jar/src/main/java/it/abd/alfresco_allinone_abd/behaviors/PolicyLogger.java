...
public class PolicyLogger implements ContentServicePolicies.OnContentUpdatePolicy, 
            ContentServicePolicies.OnContentReadPolicy, 
            NodeServicePolicies.OnCreateNodePolicy, 
            NodeServicePolicies.OnUpdateNodePolicy, 
            NodeServicePolicies.OnDeleteNodePolicy {
	
	private static org.slf4j.Logger logger = org.slf4j.LoggerFactory.getLogger(PolicyLogger.class);
	...
	public void init() {
		...
		this.policyComponent.bindClassBehaviour(OnContentReadPolicy.QNAME, ScModelParameter.TYPE_HRPOLICY, this.onContentRead);
		this.policyComponent.bindClassBehaviour(OnContentUpdatePolicy.QNAME, ScModelParameter.TYPE_HRPOLICY, this.onContentUpdate);
		this.policyComponent.bindClassBehaviour(OnCreateNodePolicy.QNAME, ScModelParameter.TYPE_HRPOLICY, this.onCreateNode);
		this.policyComponent.bindClassBehaviour(OnUpdateNodePolicy.QNAME, ScModelParameter.TYPE_HRPOLICY, this.onUpdateNode);
		this.policyComponent.bindClassBehaviour(OnDeleteNodePolicy.QNAME, ScModelParameter.TYPE_HRPOLICY, this.onDeleteNode);
		this.policyComponent.bindClassBehaviour(OnContentReadPolicy.QNAME, ScModelParameter.ASPECT_CLIENTRELATED, this.onContentRead);

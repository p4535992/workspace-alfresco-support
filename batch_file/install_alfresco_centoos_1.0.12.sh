...
#LIBRARIES FOR  SUPPORT THE JAVA MACHNE ON CENTOOS
#https://github.com/oktadeveloper/okta-aws-cli-assume-role/issues/58
# yum install -y gtk2 libXtst 
...
#yum install -y libgtk-java.x86_64 libswt3-gtk2.x86_64
#yum install -y libXtst.x86_64 
#yum install -y webkitgtk.x86_64
yum install -y gtk2 gtk3 libXtst gtkhtml2 libxslt alsalib
...
wget -O "/usr/local/src/apache-tomcat-8.5.32.zip" http://it.apache.contactlab.it/tomcat/tomcat-8/v8.5.32/bin/apache-tomcat-8.5.32.zip
unzip "/usr/local/src/apache-tomcat-8.5.32.zip" -d "/opt"

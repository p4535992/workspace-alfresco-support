 ...
 *
 */
public class RCSSingleSignDocumentsWizard extends RCSSignDocumentsWizard {
	
	private static final long serialVersionUID = 1L;

	@SuppressWarnings("unused")
	private static Logger tracer = Logger.getLogger(RCSSingleSignDocumentsWizard.class);

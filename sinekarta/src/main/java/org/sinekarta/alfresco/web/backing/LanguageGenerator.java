...
import org.sinekarta.alfresco.web.converter.LanguageConverter;

public class LanguageGenerator extends BaseComponentGenerator {
	...
	public UIComponent generate(FacesContext context, String id) {
		...
		itemsComponent.setValue(su.getLingue());

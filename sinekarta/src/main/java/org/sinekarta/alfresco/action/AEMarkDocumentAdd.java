 ...
 *
 */
public class AEMarkDocumentAdd extends ActionExecuterAbstractBase implements InitializingBean {

	private static Logger tracer = Logger.getLogger(AEMarkDocumentAdd.class);
	public static final String ACTION_NAME_AEMARK_DOCUMENT_ADD = "sinekartaAEMarkDocumentAdd";

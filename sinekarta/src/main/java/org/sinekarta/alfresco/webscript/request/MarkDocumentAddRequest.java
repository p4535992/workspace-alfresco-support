...
public class MarkDocumentAddRequest extends GenericArea{

	private String markDocumentArea;
	
	private String nodeRefs;

	public static MarkDocumentAddRequest fromXML(InputStream is) throws JAXBException {
		return (MarkDocumentAddRequest)GenericArea.fromXML(is, MarkDocumentAddRequest.class);
	}

	public static MarkDocumentAddRequest fromJSON(InputStream is) throws IOException {
		return (MarkDocumentAddRequest)GenericArea.fromJSON(is, MarkDocumentAddRequest.class);
	}

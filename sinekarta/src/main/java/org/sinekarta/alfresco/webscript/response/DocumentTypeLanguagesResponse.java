...
public class DocumentTypeLanguagesResponse extends GenericArea{

	private String userDefaultLanguage;
	
	private List<DocumentTypeLanguage> documentTypeLanguages;
	...
	public List<DocumentTypeLanguage> getDocumentTypeLanguages() {
		return documentTypeLanguages;
	}

	public void setDocumentTypeLanguages(
			List<DocumentTypeLanguage> documentTypeLanguages) {
		this.documentTypeLanguages = documentTypeLanguages;
	}

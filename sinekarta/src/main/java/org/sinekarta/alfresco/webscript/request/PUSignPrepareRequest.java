...
public class PUSignPrepareRequest extends GenericArea{

	private String digitalSignatureArea;
	
	private String nodeRefs;

	public static PUSignPrepareRequest fromXML(InputStream is) throws JAXBException {
		return (PUSignPrepareRequest)GenericArea.fromXML(is, PUSignPrepareRequest.class);
	}

	public static PUSignPrepareRequest fromJSON(InputStream is) throws IOException {
		return (PUSignPrepareRequest)GenericArea.fromJSON(is, PUSignPrepareRequest.class);
	}

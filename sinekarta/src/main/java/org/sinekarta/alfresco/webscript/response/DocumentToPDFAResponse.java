...
public class DocumentToPDFAResponse extends GenericArea{

	private String result;

	public static DocumentToPDFAResponse fromXML(InputStream is) throws JAXBException {
		return (DocumentToPDFAResponse)GenericArea.fromXML(is, DocumentToPDFAResponse.class);
	}

	public static DocumentToPDFAResponse fromJSON(InputStream is) throws IOException {
		return (DocumentToPDFAResponse)GenericArea.fromJSON(is, DocumentToPDFAResponse.class);
	}

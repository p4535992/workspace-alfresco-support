...
public class DocumentMoveToArchiveRequest extends GenericArea{
	...
	public static DocumentMoveToArchiveRequest fromXML(InputStream is) throws JAXBException {
		return (DocumentMoveToArchiveRequest)GenericArea.fromXML(is, DocumentMoveToArchiveRequest.class);
	}

	public static DocumentMoveToArchiveRequest fromJSON(InputStream is) throws IOException {
		return (DocumentMoveToArchiveRequest)GenericArea.fromJSON(is, DocumentMoveToArchiveRequest.class);
	}

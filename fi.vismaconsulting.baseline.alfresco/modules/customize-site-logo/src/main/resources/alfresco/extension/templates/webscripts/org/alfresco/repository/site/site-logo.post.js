...
function main()
{
   try
   {
      ...
      // fix permissions
      if (logoNode.inheritsPermissions()){
         logoNode.setPermission("SiteManager", site.sitePermissionGroups["SiteManager"]);
         logoNode.setPermission("SiteConsumer", "GROUP_EVERYONE");
         logoNode.setInheritsPermissions(false);
      }

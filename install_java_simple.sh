...
for dl_url in ${jdk_download_url4[@]}; do
	wget -O /usr/local/src/backup/2017-08-29/jdk-8u141-linux-x64.rpm --no-cookies --no-check-certificate --header "Cookie: oraclelicense=accept-securebackup-cookie" -N $dl_url
done

#delete /var/lib/alternatives/ on CentOS 6&7
rpm --nosignature -ivh --force --prefix=/usr/java/ /usr/local/src/backup/2017-08-29/jdk-8u141-linux-x64.rpm
